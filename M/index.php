...
<body>
	...
	<div id="parallax1">
		...
		<div class="container">
			<div class="vertical-text">
				<p class="prlx-quote">MARABIGO is a creative studio. Our team is comprised of motivated new art enthusiasts coming together to combine their crafts. We like to make things levitate, spin and inspire awe.<br/><br/>
		...
		<div class="container">
			...
			<!-- Start Filters -->
                <ul class="option-set" data-option-key="filter">
			    	...
			    	<li><a class="selected" href="#filter" data-option-value="*"><span></span>Select Projects</a></li>
                    ...
                    <li><a href="#filter" data-option-value=".collaboration"><span></span>Collaboration</a></li>
		    	</ul>
			<!-- End Filters -->
			...
			<!-- Superstar -->
			<div class="three columns item isotope-item collaboration">
				<a href="superstar.html">
					<div class="img-wrp">
                        <img class="scaleimg" src="images/thumb_superstar.jpg" alt="Superstar | Jesse Marco | Marabigo NYC" />
				        <div class="overlay-wrp">
		    		        <i class="icon loupe overlay-content"></i>
		    		        <div class="overlay"></div>
				        </div>
			    ...
			    <p class="project-title"> <a href="superstar.html">Superstar</a></p>
				<p class="project-description">by Jesse Marco<br/>Music Video<br/>Production Company: Airebedd<br/><br/>
                Coloring + VFX: MARABIGO</p>
			...
			<!-- Propioception -->
			<div class="three columns item isotope-item collaboration">
				<a href="proprioception.html">
					<div class="img-wrp">
                        <img class="scaleimg" src="images/thumb_prop.jpg" alt="Proprioception | Keenan Jolliff | Marabigo NYC" />
				        <div class="overlay-wrp">
		    		        <i class="icon loupe overlay-content"></i>
		    		        <div class="overlay"></div>
				        </div>
			    ...
			    <p class="project-title"> <a href="proprioception.html">Proprioception</a></p>
				<p class="project-description">by Keenan Jolliff<br/>Music Video<br/>Shot by Tyler Isaacson and Arina Bleiman...<br/><br/>
                Title Graphics: MARABIGO</p>
			...
			<!-- Acceptance -->
			<div class="three columns item isotope-item collaboration">
				<a href="acceptance.html">
					<div class="img-wrp">
                        <img class="scaleimg" src="images/thumb_accept.jpg" alt="Acceptance | Marabigo NYC" />
				        <div class="overlay-wrp">
		    		        <i class="icon loupe overlay-content"></i>
		    		        <div class="overlay"></div>
				        </div>
			    ...
			    <p class="project-title"> <a href="acceptance.html">Acceptance</a></p>
				<p class="project-description">
				 Independent Film<br/><br/>
                "Acceptance" is a Singaporean Independent Film based on a true story...
                <br/><br/>
                Visual Effects: MARABIGO</p>
			...
			<div class="three columns item isotope-item post">
				<a href="sketch.html">
					<div class="img-wrp">
                        <img class="scaleimg" src="images/thumb_sketch.jpg" alt="Sketch | Vera Wang | Marabigo NYC" />
				        <div class="overlay-wrp">
		    		        <i class="icon loupe overlay-content"></i>
		    		        <div class="overlay"></div>
				        </div>
			    ...
			    <p class="project-title"> <a href="sketch.html">Sketch</a></p>
				<p class="project-description">A visual exploration of a Vera Wang Fall 2013 Wedding Gown: from the blank page to the showroom.<br/><br/></p>
			...
			<div class="three columns item isotope-item pre">
				<a href="enso.html">
					<div class="img-wrp">
                        <img class="scaleimg" src="images/thumb_enso.png" alt="Acceptance | Marabigo NYC" />
				        <div class="overlay-wrp">
		    		        <i class="icon loupe overlay-content"></i>
		    		        <div class="overlay"></div>
				        </div>
			    ...
			    <p class="project-title"> <a href="enso.html">ENSO COLLECTIVE</a></p>
				<p class="project-description">
				Music Video<br/><br/>
				Director: Jean Claude Billmaier<br/>
				Album: Loop (2013)<br/>
				Artist: Ensō Collective<br/>
				</p>
			</div>	
				...
				<!-- 2 Over 10 -->
			<div class="three columns item isotope-item post">
				<a href="ducky2over10.html">
					<div class="img-wrp">
                        <img class="scaleimg" src="images/thumb_ducky2over10.jpg" alt="Ducky 2 Over 10 | Marabigo NYC" />
				        <div class="overlay-wrp">
		    		        <i class="icon loupe overlay-content"></i>
		    		        <div class="overlay"></div>
				        </div>
			    ...
			    <p class="project-title"> <a href="ducky2over10.html">Two Over Ten</a></p>
		<p class="project-description">Music Video for Two Over Ten - by Ducky.</p>
	...
	<div id="services" class="page">
		<div class="container">
		      <h1><img src="images/services.jpg" alt="Production. Post Production. Creative Direction"></h1>
		</div>	
	</div>
		...
		<div class="pattern"></div>
			<div class="sixteen columns">
				...
				<div class="card">
					...
					<h2>NEED SOMETHING? SEND US A <font style="text-decoration:underline;"><a href="mailto:hello@marabigo.com">message</a></font>.</h2>
				<div>
    ...
    <div class="mnav">
        <div class="menu">
            <ul id="nav" class="links">
                ...
                <li><div class="menuOption9"><a class="menuLink smoothScroll" href="#services">Services</a></div></li>
